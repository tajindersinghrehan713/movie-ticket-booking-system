...
class Booking {
    ...
    public:
        ...
        void addSeat(ShowSeat* seat) { 
            this->bookedSeats.push_back(seat); 
        }
        void addSnackOrder(SnackOrder order) { 
            this->snackOrders.push_back(order); 
        }
        void setBookingAmount(double amount) { 
        ...
        vector<ShowSeat*>& getBookedSeats() { 
            return this->bookedSeats; 
        }
        vector<SnackOrder>& getSnackOrders() { 
            return this->snackOrders; 
        }
